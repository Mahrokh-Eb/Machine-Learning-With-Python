...
Discroption:
Write a program that asks for the names of three runners and the time it took each of them to ﬁnish a race.
program should display who came in ﬁrst, second, and third place.
